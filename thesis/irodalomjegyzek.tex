...
\bibitem{zipper}Wikibooks, the open-content textbooks collection
  ...
  2009. május 26.)
\bibitem{laziness}Wikibooks, the open-content textbooks collection
  \tit{Haskell/Laziness}, 14 March 2009. Link:
  \url{http://en.wikibooks.org/wiki/Haskell/Laziness} (elérés dátuma:
  2009. június 6.)
\bibitem{tutorial98}Paul Hudak, John Peterson, Joseph Fasel: \tit{A
  Gentle Introduction to Haskell Version 98}, Online tutorial,
  2000. június, Link:\url{http://www.haskell.org/tutorial/} (elérés
  dátuma: 2009. június 6.)
\bibitem{yaht}Hal Daume III: \tit{Yet Another Haskell Tutorial},
  Online tutorial, 2006,
  Link:\url{http://darcs.haskell.org/yaht/yaht.pdf} (elérés dátuma:
  2009. június 10.)
